...
- **Кэширование:** Реализует in-memory кэширование токенов для повышения производительности. Это основной механизм кэширования, который сбрасывается при перезапуске приложения.
